...
### 1. Sunday Night Weekly Planning (Sunday {{WEEKLY_PLAN_TIME}})
...
### 2. Morning Dispatch (Weekdays {{DISPATCH_TIME}})
...
### 3. Midday Check-in (Weekdays {{MIDDAY_TIME}})
...
### 4. Afternoon Check-in (Weekdays {{AFTERNOON_TIME}})
...
### 5. End of Day Summary (Weekdays {{EOD_TIME}})
